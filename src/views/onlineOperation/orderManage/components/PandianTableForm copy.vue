    ...
    <div class="sub-node">
        ...
        <div>
            <div class="flex align-center justify-end top-button">
                ...
                <el-button type="primary" plain size="mini" @click="handleDownload" class="ml10"
                    v-if="type != 'detail'">模板下载</el-button>
                        ...
                        <template slot-scope="scope">
                            <div class="operate">
                                <el-button type="primary" icon="el-icon-plus" size="mini"
                                    v-if="(scope.$index + 1) == tableFormData.dataList.length"
                                    @click="addList(scope.$index)"></el-button>
                                <el-button type="primary" icon="el-icon-minus" size="mini" v-else
                            ...
                            <div class="edit-input">
                                <el-form-item :prop="'dataList.' + scope.$index + '.' + item.prop"
                                    ...
                                    <el-select v-model="scope.row[item.prop]" :placeholder="item.placeholder"
                                        :style="{ width: '100%' }" v-if="item.prop == 'isNegativeList'">
                                        <el-option value="1" label="是"></el-option>
                                        <el-option value="0" label="否"></el-option>
                                    </el-select>
                                    <el-select v-model="scope.row[item.prop]" :placeholder="item.placeholder"
                                        :style="{ width: '100%' }" v-if="item.prop == 'isConnectedMiddleStation'">
                                        <el-option value="1" label="是"></el-option>
                                        <el-option value="0" label="否"></el-option>
                                    </el-select>
                                    <el-select v-model="scope.row[item.prop]" :placeholder="item.placeholder"
...
<script>
const tableformInfo = [
    { label: "盘点层级", width: "140", prop: "inventoryLevel", type: 'input', isRequire: true, placeholder: '请输入' },
    { label: "系统名称", width: "140", prop: "sysName", type: 'input', isRequire: true, placeholder: '请输入' },
    { label: "项目空间或源端库名", width: "160", prop: "projectSpace", type: 'input', isRequire: true, placeholder: '请选择' },
    { label: "表英文名", width: "180", prop: "tableEn", type: 'input', isRequire: true, placeholder: '请输入' },
    { label: "部署方式", width: "200", prop: "deployType", type: 'input', isRequire: true, placeholder: '请输入' },
    { label: "字段英文名", width: "140", prop: "columnEn", type: 'input', isRequire: true, placeholder: '请输入' },
    { label: "字段中文名", width: "200", prop: "columnCh", type: 'input', isRequire: true, placeholder: '请输入' },
    { label: "是否负面清单", width: "140", prop: "isNegativeList", type: 'select', isRequire: true, placeholder: '请选择' },
    { label: "是否接入中台", width: "140", prop: "isConnectedMiddleStation", type: 'select', isRequire: true, placeholder: '请选择' },
    { label: "应用名称", width: "160", prop: "applyName", type: 'input', isRequire: true, placeholder: '请输入' },
    { label: "挂接三级目录", width: "140", prop: "attachThirdLevelDir", type: 'input', isRequire: true, placeholder: '请输入' },
...
export default {
    ...
    created() {
        ...
        this.tableFormData.dataList = this.dataList
    },
    methods: {
        // 增加行
        addList() {
