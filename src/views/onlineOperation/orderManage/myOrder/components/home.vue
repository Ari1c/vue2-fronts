                ...
                <el-table :data="dataList" :height="height" stripe v-loading="loading" ref="table">
                    ...
                    <el-table-column align="center" label="操作" width="160" fixed="right">
                        <templete slot-scope="scope" class="operBtn">
                            <el-button v-show="scope.row.status == '1'" size="mini" type="primary" plain
                                icon="el-icon-edit-outline" @click="edit(scope.row)">编辑</el-button>
                            <!-- <el-button v-show="scope.row.status == '1'" size="mini" type="success" plain
                                icon="el-icon-edit-outline" @click="assign(scope.row)">指派</el-button> -->
                            <el-button slot="reference" @click="detail(scope.row)" size="mini" type="warning" plain
                                icon="el-icon-document" class="ml10">详情</el-button>
                        </templete>
                    </el-table-column>
                </el-table>
