...
const formInfo = [
  ...
  {
    label: "是否完成:", key: "isComplete", type: "select", disabled: false, width: "84px",
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      https.dataDownList(this.formData).then(res => {
